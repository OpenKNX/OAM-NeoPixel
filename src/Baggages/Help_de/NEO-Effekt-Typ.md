...
34 | Snake 2D              | Klassisches Snake; Schlange frisst zufälliges Futter und wächst
35 | Matrix 2D             | Digitaler Matrix-Regen (Grün/Gold/Gemischt) mit Glitch-Blitzen
36 | Tetris 2D             | Klassisches Tetris (7 Tetrominoes, SRS-Rotation, Geist-Stein, Linien-Flash)
37 | TRON                  | Neon-Grid mit bewegten Scanlinien im TRON-Stil
38 | Starfield Warp        | Sternenfeld mit Warp-Tunnel-Effekt
39 | Plasma Nebula         | Mehrlagige Plasma-Nebel-Animation
40 | UFO Swarm             | Mehrere UFOs mit optionalem Traktorstrahl
```
