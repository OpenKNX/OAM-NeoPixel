...
Definiert die RGB-Farbe, die beim Start des Segments oder beim Zurücksetzen verwendet wird.
...
Zusätzlich zur RGB-Farbe können Sie auch den **W-Kanal** (Weiß) separat einstellen, falls Sie RGBW-LEDs verwenden.
