...
```powershell
pwsh scripts/Build-HardwareConfig.ps1 -FeatureName NeoPixel -DefinesPrefix NEO
```
...
& "$PSScriptRoot/Build-HardwareConfig.ps1" -FeatureName NeoPixel -DefinesPrefix NEO
...
pwsh scripts/Build-HardwareConfig.ps1 -VerboseMode
...
```powershell
pwsh scripts/Build-HardwareConfig.ps1 -CleanOnly
```
...
```powershell
pwsh scripts/Build-HardwareConfig.ps1 -DryRun -VerboseMode
```
...
```bash
cp scripts/Build-HardwareConfig.ps1 scripts/Build-MyFeatureGPIO.ps1
```
...
```javascript
// Auto-generated by Build-HardwareConfig.ps1
...
1. **Enable verbose mode**: `pwsh scripts/Build-HardwareConfig.ps1 -VerboseMode`
