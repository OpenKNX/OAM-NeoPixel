...
// Third-party hardware flag (1 = not OpenKNX, no support -> ETS warning)
#ifdef NEOPIXEL_HW_THIRDPARTY_NO_SUPPORT
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    HW_THIRDPARTY_NO_SUPPORT = EXPAND(NEOPIXEL_HW_THIRDPARTY_NO_SUPPORT)
#else
    HW_THIRDPARTY_NO_SUPPORT = 0
#endif
