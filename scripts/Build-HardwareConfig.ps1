...
function Generate-HardwareSpecificGPIOSelectionUI {
  ...
  foreach ($hw in $hardwareList) {
    ...
    if ($Type -eq "Data") {
      ...
      $xml += "          <when test=`"5 6 21 22 23 24 25`">`n"
...
function Generate-HardwareIdMappingJS {
  ...
  $jsMapping += "// Auto-generated by Build-HardwareConfig.ps1 - do not edit`n"
...
function Generate-GPIOPortMappingJS {
  ...
  try {
    ...
    $jsPortMaps = "  // Auto-generated by Build-HardwareConfig.ps1 - do not edit`n"
...
function Generate-HardwareMappingHeader {
  ...
  try {
    ...
    $year = 2026   # fixed -> deterministic output (no per-build churn); bump when needed
