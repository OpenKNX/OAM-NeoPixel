...
function Generate-RelayConfigParametersInShare {
  ...
  $paramsXml += "`n              <!-- External Relay Names (ETS labels only) -->`n"
  $paramsXml += "              <Union SizeInBit=`"448`">`n"
  $paramsXml += "                <Memory CodeSegment=`"%AID%_RS-04-00000`" Offset=`"138`" BitOffset=`"0`" />`n"
  $paramsXml += "                <Parameter Id=`"%AID%_UP-%TT%00182`" Offset=`"0`"  BitOffset=`"0`" Name=`"NEOExternalRelay1Name`" ParameterType=`"%AID%_PT-RelayName`" Text=`"Beschreibung`" Value=`"`"/>`n"
  $paramsXml += "                <Parameter Id=`"%AID%_UP-%TT%00183`" Offset=`"14`" BitOffset=`"0`" Name=`"NEOExternalRelay2Name`" ParameterType=`"%AID%_PT-RelayName`" Text=`"Beschreibung`" Value=`"`"/>`n"
  $paramsXml += "                <Parameter Id=`"%AID%_UP-%TT%00184`" Offset=`"28`" BitOffset=`"0`" Name=`"NEOExternalRelay3Name`" ParameterType=`"%AID%_PT-RelayName`" Text=`"Beschreibung`" Value=`"`"/>`n"
  $paramsXml += "                <Parameter Id=`"%AID%_UP-%TT%00185`" Offset=`"42`" BitOffset=`"0`" Name=`"NEOExternalRelay4Name`" ParameterType=`"%AID%_PT-RelayName`" Text=`"Beschreibung`" Value=`"`"/>`n"
  $paramsXml += "              </Union>"
...
function Generate-RelayParameterRefsInShare {
  ...
  $refsXml += "              <ParameterRef Id=`"%AID%_UP-%TT%00182_R-%TT%0018201`" RefId=`"%AID%_UP-%TT%00182`" />`n"
  $refsXml += "              <ParameterRef Id=`"%AID%_UP-%TT%00183_R-%TT%0018301`" RefId=`"%AID%_UP-%TT%00183`" />`n"
  $refsXml += "              <ParameterRef Id=`"%AID%_UP-%TT%00184_R-%TT%0018401`" RefId=`"%AID%_UP-%TT%00184`" />`n"
  $refsXml += "              <ParameterRef Id=`"%AID%_UP-%TT%00185_R-%TT%0018501`" RefId=`"%AID%_UP-%TT%00185`" />`n"
...
function Generate-RelayParameterTypeInShare {
  ...
  $ptXml += "                <TypeText SizeInBit=`"112`" />`n"
  $ptXml += "              </ParameterType>"
...
function Generate-RelayUIInShare {
  ...
  $uiXml += "          <ParameterRefRef RefId=`"%AID%_UP-%TT%00182_R-%TT%0018201`" Cell=`"1,2`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "            <ParameterRefRef RefId=`"%AID%_UP-%TT%00183_R-%TT%0018301`" Cell=`"2,2`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "            <ParameterRefRef RefId=`"%AID%_UP-%TT%00184_R-%TT%0018401`" Cell=`"3,2`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "            <ParameterRefRef RefId=`"%AID%_UP-%TT%00185_R-%TT%0018501`" Cell=`"4,2`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "    <choose ParamRefId=`"%AID%_UP-%TT%00130_R-%TT%0013001`">`n"
  $uiXml += "      <when test=`">=1`">`n"
  $uiXml += "        <ParameterBlock Id=`"%AID%_PB-nnn`" Name=`"Relais1`" Text=`"Relais 1: {{0:...}}`" Icon=`"relay`" ShowInComObjectTree=`"true`" TextParameterRefId=`"%AID%_UP-%TT%00182_R-%TT%0018201`">`n"
  $uiXml += "        <ParameterRefRef RefId=`"%AID%_UP-%TT%00182_R-%TT%0018201`" IndentLevel=`"1`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "    <choose ParamRefId=`"%AID%_UP-%TT%00130_R-%TT%0013001`">`n"
  $uiXml += "      <when test=`">=2`">`n"
  $uiXml += "        <ParameterBlock Id=`"%AID%_PB-nnn`" Name=`"Relais2`" Text=`"Relais 2: {{0:...}}`" Icon=`"relay`" ShowInComObjectTree=`"true`" TextParameterRefId=`"%AID%_UP-%TT%00183_R-%TT%0018301`">`n"
  $uiXml += "        <ParameterRefRef RefId=`"%AID%_UP-%TT%00183_R-%TT%0018301`" IndentLevel=`"1`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "    <choose ParamRefId=`"%AID%_UP-%TT%00130_R-%TT%0013001`">`n"
  $uiXml += "      <when test=`">=3`">`n"
  $uiXml += "        <ParameterBlock Id=`"%AID%_PB-nnn`" Name=`"Relais3`" Text=`"Relais 3: {{0:...}}`" Icon=`"relay`" ShowInComObjectTree=`"true`" TextParameterRefId=`"%AID%_UP-%TT%00184_R-%TT%0018401`">`n"
  $uiXml += "        <ParameterRefRef RefId=`"%AID%_UP-%TT%00184_R-%TT%0018401`" IndentLevel=`"1`" HelpContext=`"NEO-Relais-Name`" />`n"
  ...
  $uiXml += "    <choose ParamRefId=`"%AID%_UP-%TT%00130_R-%TT%0013001`">`n"
  $uiXml += "      <when test=`">=4`">`n"
  $uiXml += "        <ParameterBlock Id=`"%AID%_PB-nnn`" Name=`"Relais4`" Text=`"Relais 4: {{0:...}}`" Icon=`"relay`" ShowInComObjectTree=`"true`" TextParameterRefId=`"%AID%_UP-%TT%00185_R-%TT%0018501`">`n"
  $uiXml += "        <ParameterRefRef RefId=`"%AID%_UP-%TT%00185_R-%TT%0018501`" IndentLevel=`"1`" HelpContext=`"NEO-Relais-Name`" />`n"
