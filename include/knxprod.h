...
#define MAIN_FirmwareName "OpenKNX NeoPixel"
...
#define LMG_KoLMGHCLLock 1252
#define LMG_KoLMGHCLLockStatus 1253
#define LMG_KoLMGHCLReleaseTrigger 1254
...
// deprecated
#define LMG_KoOffset 1260

// Communication objects per channel (multiple occurrence)
#define LMG_KoBlockOffset 1260
...
// Start-Effekt
#define ParamNEO_NEOSegmentStartupEffect             (PT_NEOEffectType)(knx.paramByte(NEO_ParamCalcIndex(NEO_NEOSegmentStartupEffect)))
// Speed (Wipe)
...
// deprecated
#define NEOEM_KoOffset 1612

// Communication objects per channel (multiple occurrence)
#define NEOEM_KoBlockOffset 1612
#define NEOEM_KoBlockSize 9

#define NEOEM_KoCalcNumber(index) (index + NEOEM_KoBlockOffset + _channelIndex * NEOEM_KoBlockSize)
#define NEOEM_KoCalcIndex(number) ((number >= NEOEM_KoCalcNumber(0) && number < NEOEM_KoCalcNumber(NEOEM_KoBlockSize)) ? (number - NEOEM_KoBlockOffset) % NEOEM_KoBlockSize : -1)
#define NEOEM_KoCalcChannel(number) ((number >= NEOEM_KoBlockOffset && number < NEOEM_KoBlockOffset + NEOEM_ChannelCount * NEOEM_KoBlockSize) ? (number - NEOEM_KoBlockOffset) / NEOEM_KoBlockSize : -1)

#define NEOEM_KoEmStart 0
#define NEOEM_KoEmStatus 1
#define NEOEM_KoEmStop 2
#define NEOEM_KoEmCueStatus 3
#define NEOEM_KoEmCueSet 4
#define NEOEM_KoEffectText 5
#define NEOEM_KoEffectTextStatus 6
#define NEOEM_KoEffectTextAppend 7
#define NEOEM_KoSyncChain 8

// Effektmanager Start
#define KoNEOEM_EmStart                             (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEmStart)))
// Effektmanager Status
#define KoNEOEM_EmStatus                            (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEmStatus)))
// Effektmanager Stop
#define KoNEOEM_EmStop                              (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEmStop)))
// Aktive Cue
#define KoNEOEM_EmCueStatus                         (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEmCueStatus)))
// Cue setzen
#define KoNEOEM_EmCueSet                            (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEmCueSet)))
// Effekt-Text
#define KoNEOEM_EffectText                          (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEffectText)))
// Effekt-Text Status
#define KoNEOEM_EffectTextStatus                    (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEffectTextStatus)))
// Effekt-Text Anhängen
#define KoNEOEM_EffectTextAppend                    (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoEffectTextAppend)))
// Effektkette Sync
#define KoNEOEM_SyncChain                           (knx.getGroupObject(NEOEM_KoCalcNumber(NEOEM_KoSyncChain)))
...
#define BASE_KommentarModuleParamOffset 43659
